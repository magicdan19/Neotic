...
echo_and_run cd "/catkin_ws/src/rtabmap_ros"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/catkin_ws/src/rtabmap_ros/setup.py" \
    egg_info --egg-base /catkin_ws/build/rtabmap_ros \
    build --build-base "/catkin_ws/build/rtabmap_ros" \
    install \
    --root="${DESTDIR-/}" \
