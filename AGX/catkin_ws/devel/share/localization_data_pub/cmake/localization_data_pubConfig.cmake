...
if("TRUE" STREQUAL "TRUE")
  set(localization_data_pub_SOURCE_PREFIX /catkin_ws/src/localization_data_pub)
  set(localization_data_pub_DEVEL_PREFIX /catkin_ws/devel)
  ...
  set(localization_data_pub_INSTALL_PREFIX /catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'localization_data_pub' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/catkin_ws/src/localization_data_pub/${idir}'.  ${_report}")
    endif()
